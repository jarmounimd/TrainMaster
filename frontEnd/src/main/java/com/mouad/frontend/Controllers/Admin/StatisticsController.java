...
public class StatisticsController {
    ...
    public void initialize() {
        try {
            ...
            trainsIcon.getStyleClass().remove("active");
            schedulesIcon.getStyleClass().remove("active");
            bookingsIcon.getStyleClass().remove("active");
            statisticsIcon.getStyleClass().add("active");
            
            // Set active states for labels
            homeLabel.getStyleClass().remove("active");
            trainsLabel.getStyleClass().remove("active");
            schedulesLabel.getStyleClass().remove("active");
            bookingsLabel.getStyleClass().remove("active");
            statisticsLabel.getStyleClass().add("active");
